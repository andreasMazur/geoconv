...
def hyper_tuning(dataset_path,
    ...
    def build_hypermodel(hp):
        ...
        signal_output = ModelNetClf(
            ...
            isc_layer_dims=[
                hp.Int("dim_1", min_value=32, max_value=128),
                hp.Int("dim_2", min_value=32, max_value=128),
                hp.Int("dim_3", min_value=32, max_value=128),
                hp.Int("dim_4", min_value=32, max_value=128),
                hp.Int("dim_5", min_value=32, max_value=128),
                hp.Int("dim_6", min_value=32, max_value=128),
                hp.Int("dim_7", min_value=32, max_value=128),
                hp.Int("dim_8", min_value=32, max_value=128)
            ],
