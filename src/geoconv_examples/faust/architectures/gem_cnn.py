...
def define_model(input_types,
                 ...
                 learning_rate=0.001,
                 lr_decay_rate=1.0):
    """Builds and compiles a GEM-CNN-model for the FAUST benchmark.

    Parameters
    ----------
    input_types: list
        A list of lists, where each sub-list contains the input types for one GEM-CNN layer.
    output_types: list
        A list of lists, where each sub-list contains the output types for one GEM-CNN layer.
    preprocess_method: str
    ...
    -------
    tf.keras.Model:
        The GEM-CNN-model for the FAUST benchmark.
    """
    # Define input layers
