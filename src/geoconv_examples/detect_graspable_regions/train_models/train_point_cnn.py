...
def train_single_imcnn(data_path,
    ...
    for epoch in range(n_epochs):
        ...
        train_hist["train_loss"].append(epoch_train_hist["epoch_loss"])
        train_hist["train_accuracy"].append(epoch_train_hist["epoch_accuracy"])
        ...
        if not skip_validation:
            ...
            train_hist["val_loss"].append(epoch_val_hist["val_epoch_loss"])
            train_hist["val_accuracy"].append(epoch_val_hist["val_epoch_accuracy"])
    ...
    if not skip_testing:
        ...
        train_hist["test_loss"].append(epoch_test_hist["val_epoch_loss"])
        train_hist["test_accuracy"].append(epoch_test_hist["val_epoch_accuracy"])
