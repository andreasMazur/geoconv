...
def train_n_imcnns(n, data_path, n_epochs, logging_dir=None, verbose=True):
    """Train the given model n times."""
    # Train models
    training_histories = []
    for repetition in range(n):
        print(f"### Repetition {repetition} ###")
        _, train_hist = train_single_imcnn(data_path, n_epochs=n_epochs, logging_dir=f"{logging_dir}/rep_{repetition}")
